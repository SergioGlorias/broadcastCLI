...
Commands:
  ...
  getPlayers <broadcastId> <style>
     Retrieve player information for a specific broadcast.
     Note: The style parameter determines the format of the player information returned.
